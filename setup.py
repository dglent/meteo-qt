...
setup(
    ...
    data_files=[('/usr/share/applications',['share/meteo-qt.desktop']),
            ...
            ('/usr/share/meteo_qt/images',['meteo_qt/images/application-exit.png',
            ...
            ('/usr/share/meteo_qt/translations', ['meteo_qt/translations/meteo-qt_bg.qm',
            ...
            ('/usr/share/doc/meteo-qt', ['README.md','LICENSE','CHANGELOG', 'TODO'])],

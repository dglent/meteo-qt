...
class WeatherConditions(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.beaufort = {'0': QCoreApplication.translate('Beaufort scale 0 - Wikipedia', 'Sea: Sea like a mirror\nLand: Calm. Smoke rises vertically', 'Tooltip in Weather overview dialogue'),
                         ...
                         '5': QCoreApplication.translate('Beaufort scale 5 - Wikipedia', 'Sea: Moderate waves of some length. Many whitecaps. Small amounts of spray\nLand: Branches of a moderate size move. Small trees in leaf begin to sway', 'Tooltip in Weather overview dialogue'),
                         ...
                         '8': QCoreApplication.translate('Beaufort scale 8 - Wikipedia', 'Sea: Moderately high waves with breaking crests forming spindrift. Well-marked streaks of foam are blown along wind direction. Considerable airborne spray\nLand: Some twigs broken from trees. Cars veer on road. Progress on foot is seriously impeded', 'Tooltip in Weather overview dialogue'),
                         '9': QCoreApplication.translate('Beaufort scale 9 - Wikipedia', 'Sea: High waves whose crests sometimes roll over. Dense foam is blown along wind direction. Large amounts of airborne spray may begin to reduce visibility\nLand: Some branches break off trees, and some small trees blow over. Construction/temporary signs and barricades blow over', 'Tooltip in Weather overview dialogue'),
        ...
        self.pressure = {'hpa': QCoreApplication.translate('From the site: Why hPa Is Used - http://n-a-c.biz/WS62694/hPa.htm', 'If the barometric pressure is rising, the weather is improving.\nIf the barometric pressure is falling, the weather is worsening.\nAbove 1020 hPa is calm weather/cooler temperatures and below that is unsettled weather/warmer temperatures.\n1010-1020 hPa would be weak to normal storms.\n990-1010 hPa would be bad storms with possible hurricanes, tornadoes, and typhoons.\nBelow 990 hPa is the pressure for VERY BAD and POWERFUL hurricanes, tornadoes, and typhoons.', 'Tooltip for the pressure label in weather overview')
                         }
